import{_ as l,M as v,p as a,q as r,R as n,N as d,V as s,t as i,a1 as m}from"./framework-bcfb0e46.js";const c="/MyBlog/assets/1607332521437-6daa8293.png",u="/MyBlog/assets/1607332539137-be357ea2.png",b={},E=n("h1",{id:"_05-补充笔记-加餐",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_05-补充笔记-加餐","aria-hidden":"true"},"#"),i(" 05 - 补充笔记(加餐) 🥠")],-1),t={class:"table-of-contents"},p=m(`<h2 id="主键" tabindex="-1"><a class="header-anchor" href="#主键" aria-hidden="true">#</a> 主键</h2><p>数据库对表的约束</p><p>保证数据库中数据的完整性，唯一性，不能为 null;</p><h2 id="外键" tabindex="-1"><a class="header-anchor" href="#外键" aria-hidden="true">#</a> 外键</h2><p>A 表与 B 表之间的关联字段，A 表中的某一个字段通过 B 表中的主键进行关联</p><p>外键可以重复，也可以为 null</p><h2 id="函数额外补充" tabindex="-1"><a class="header-anchor" href="#函数额外补充" aria-hidden="true">#</a> 函数额外补充</h2><div class="language-mysql line-numbers-mode" data-ext="mysql"><pre class="language-mysql"><code>一、数学函数
